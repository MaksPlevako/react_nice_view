...
export default function Features() {
	return (
		<section className='mt-12 w-full h-[700px] lg:h-[980px] relative'>
			...
			<div className=''>
				<div className='mt-12 lg:ml-12'>
					<img
						className='absolute top-20 left-0 w-1/3 lg:top-[250px] lg:left-[200px]'
						src={features1}
						alt='1'
					/>
					<img
				...
				<div className='font-serif text-3xl italic relative w-full h-[600px] lg:w-[500px] lg:text-4xl lg:absolute lg:top-1/3 lg:right-3 lg:grid lg:grid-cols-2 lg:gap-12'>
					<div className=' text-blue-800 absolute left-1/2 top-0'>
						<span className='text-6xl font-semibold'>88</span>
						<br /> сучасних квартир
					</div>
					<div className='text-yellow-800 absolute left-1/2 top-1/4'>
						<span className='text-6xl font-semibold'>300</span> <br />
						задоволених власників
					</div>
					<div className='text-yellow-800 absolute left-10 bottom-1/4'>
						<span className='text-6xl font-semibold'>40+</span>
						<br /> об’єктів інфраструктури
					</div>
					<div className='text-blue-800 absolute left-10 bottom-0'>
